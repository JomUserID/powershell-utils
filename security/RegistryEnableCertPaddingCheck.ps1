...
Set-ItemProperty -Path $Path1 -Name "EnableCertPaddingCheck" -Value "1" -Type "String"


if (!(Test-Path $Path2)) {
    New-Item -Path $Path2 -Force | Out-Null
}
Set-ItemProperty -Path $Path2 -Name "EnableCertPaddingCheck" -Value "1" -Type "String"
